...
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_mp_1_F010_PP0_MMU_APB_check_0_a.h"
#include "m400_mp_1_F010_PP0_MMU_APB_check_0_b.h"
#include "m400_mp_1_F010_PP0_MMU_APB_check_0_c.h"

int Check_m400_mp_1_F010_PP0_MMU_APB_check_0_a ();
int Check_m400_mp_1_F010_PP0_MMU_APB_check_0_b ();
int Check_m400_mp_1_F010_PP0_MMU_APB_check_0_c ();

int RunMaliTest_m400_mp_1_F010_PP0_MMU_APB_part0 (void);

static int mali_step;

int RunMaliTest_m400_mp_1_F010_PP0_MMU_APB (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_mp_1_F010_PP0_MMU_APB_part0();
    default : return 0;
  };
};
...
int RunMaliTest_m400_mp_1_F010_PP0_MMU_APB_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_mp_1_F010_PP0_MMU_APB\n");
  ...
  res |= Check_m400_mp_1_F010_PP0_MMU_APB_check_0_a();
  ...
  res |= Check_m400_mp_1_F010_PP0_MMU_APB_check_0_b();

  /* COMMENT */                                      /* # Reset and dump registers. */
  Mali_Reset();                                      /* reset */
  /* SEE BELOW */                                    /* dump_reg 12000000 12000024 > regdump2.hex */
  res |= Check_m400_mp_1_F010_PP0_MMU_APB_check_0_c();
...
int Check_m400_mp_1_F010_PP0_MMU_APB_check_0_a () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_mp_1_F010_PP0_MMU_APB_check_0_a.data_12000000,2,1,0x0,0x24);
  return res;
};

int Check_m400_mp_1_F010_PP0_MMU_APB_check_0_b () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_mp_1_F010_PP0_MMU_APB_check_0_b.data_12000000,2,1,0x0,0x24);
  return res;
};

int Check_m400_mp_1_F010_PP0_MMU_APB_check_0_c () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_mp_1_F010_PP0_MMU_APB_check_0_c.data_12000000,2,1,0x0,0x24);
  return res;
};
