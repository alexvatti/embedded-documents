...
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_mp_2_F024_GP_PP0_PP1_check_0_a.h"
#include "m400_mp_2_F024_GP_PP0_PP1_check_0_b.h"
#include "m400_mp_2_F024_GP_PP0_PP1_check_0_c.h"
#include "m400_mp_2_F024_GP_PP0_PP1_check_0_d.h"
#include "m400_mp_2_F024_GP_PP0_PP1_check_0_e.h"
#include "m400_mp_2_F024_GP_PP0_PP1_check_0_f.h"
#include "m400_mp_2_F024_GP_PP0_PP1_mem_0.h"

int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_a (struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *p);
int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_b (struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *p);
int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_c ();
int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_d (struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *p);
int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_e ();
int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_f (struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *p);

int RunMaliTest_m400_mp_2_F024_GP_PP0_PP1_part0 (void);
int RunMaliTest_m400_mp_2_F024_GP_PP0_PP1_part1 (void);

static volatile struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *malidata_0;
static int mali_step;

int RunMaliTest_m400_mp_2_F024_GP_PP0_PP1 (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_mp_2_F024_GP_PP0_PP1_part0();
    case 1  : return RunMaliTest_m400_mp_2_F024_GP_PP0_PP1_part1();
    default : return 0;
  };
};
...
int RunMaliTest_m400_mp_2_F024_GP_PP0_PP1_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_mp_2_F024_GP_PP0_PP1\n");
...
malidata_0 =(struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *)Mali_LdMem(&m400_mp_2_F024_GP_PP0_PP1_mem_0,sizeof(struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0),(int)m400_mp_2_F024_GP_PP0_PP1_mem_0.ttb_first);
...
int RunMaliTest_m400_mp_2_F024_GP_PP0_PP1_part1 (void) {
  ...
  res |= Check_m400_mp_2_F024_GP_PP0_PP1_check_0_a(malidata_0);

  /* SEE BELOW */                                    /* dump_mem 00003380 00049880 > plbu_scissor02_elements_12_dump_plbu_heap.hex */
  res |= Check_m400_mp_2_F024_GP_PP0_PP1_check_0_b(malidata_0);
  ...
  res |= Check_m400_mp_2_F024_GP_PP0_PP1_check_0_c();

  /* SEE BELOW */                                    /* dump_mem 100000c0 100020c0 > GTxx01_00000_fb.hex */
  res |= Check_m400_mp_2_F024_GP_PP0_PP1_check_0_d(malidata_0);
  ...
  res |= Check_m400_mp_2_F024_GP_PP0_PP1_check_0_e();

  /* SEE BELOW */                                    /* dump_mem 200000c0 200020c0 > GTxx09_00000_fb.hex */
  res |= Check_m400_mp_2_F024_GP_PP0_PP1_check_0_f(malidata_0);
...
int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_a (struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *p) {
  struct t_CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_a *r = &CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_a;
  int res = 0;
...
int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_b (struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *p) {
  struct t_CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_b *r = &CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_b;
  int res = 0;
...
int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_c () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_c.data_10001020,1,0,0x1030,0x103c);
  return res;
};

int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_d (struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *p) {
  struct t_CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_d *r = &CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_d;
  int res = 0;
...
int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_e () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_e.data_10011020,1,1,0x1030,0x103c);
  return res;
};

int Check_m400_mp_2_F024_GP_PP0_PP1_check_0_f (struct t_m400_mp_2_F024_GP_PP0_PP1_mem_0 *p) {
  struct t_CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_f *r = &CheckData_m400_mp_2_F024_GP_PP0_PP1_check_0_f;
  int res = 0;
  Mali_Message("Performing data check of 8192 bytes\n");
