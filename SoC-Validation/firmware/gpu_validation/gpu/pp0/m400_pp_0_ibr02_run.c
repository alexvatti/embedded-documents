...
* from ARM Limited.
*
* Modified  : $Date: 2013/05/14 11:58:34 $
* Revision  : $Revision: 1.1 $
* Release   : $State: Exp $
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_pp_0_ibr02_check_0_a.h"
#include "m400_pp_0_ibr02_check_0_b.h"
#include "m400_pp_0_ibr02_check_0_c.h"
#include "m400_pp_0_ibr02_check_0_d.h"
#include "m400_pp_0_ibr02_check_0_e.h"
#include "m400_pp_0_ibr02_check_0_f.h"
#include "m400_pp_0_ibr02_check_0_g.h"
#include "m400_pp_0_ibr02_check_0_h.h"
#include "m400_pp_0_ibr02_check_0_i.h"
#include "m400_pp_0_ibr02_check_0_j.h"
#include "m400_pp_0_ibr02_check_0_k.h"
#include "m400_pp_0_ibr02_check_0_l.h"
#include "m400_pp_0_ibr02_check_0_m.h"
#include "m400_pp_0_ibr02_check_0_n.h"
#include "m400_pp_0_ibr02_check_0_o.h"

int Check_m400_pp_0_ibr02_check_0_a ();
int Check_m400_pp_0_ibr02_check_0_b ();
int Check_m400_pp_0_ibr02_check_0_c ();
int Check_m400_pp_0_ibr02_check_0_d ();
int Check_m400_pp_0_ibr02_check_0_e ();
int Check_m400_pp_0_ibr02_check_0_f ();
int Check_m400_pp_0_ibr02_check_0_g ();
int Check_m400_pp_0_ibr02_check_0_h ();
int Check_m400_pp_0_ibr02_check_0_i ();
int Check_m400_pp_0_ibr02_check_0_j ();
int Check_m400_pp_0_ibr02_check_0_k ();
int Check_m400_pp_0_ibr02_check_0_l ();
int Check_m400_pp_0_ibr02_check_0_m ();
int Check_m400_pp_0_ibr02_check_0_n ();
int Check_m400_pp_0_ibr02_check_0_o ();

int RunMaliTest_m400_pp_0_ibr02_part0 (void);

static int mali_step;

int RunMaliTest_m400_pp_0_ibr02 (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_pp_0_ibr02_part0();
    default : return 0;
  };
};
...
int RunMaliTest_m400_pp_0_ibr02_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_pp_0_ibr02\n");
  ...
  /* COMMENT */                                      /* #- Dump */
  res |= Check_m400_pp_0_ibr02_check_0_a();          /* dump_reg 10000000 10000058 > ibr02_00000_reg.hex # Frame registers */
  res |= Check_m400_pp_0_ibr02_check_0_b();          /* dump_reg 10000100 10000130 > ibr02_00001_reg.hex # Writeback Registers for WB0 */
  res |= Check_m400_pp_0_ibr02_check_0_c();          /* dump_reg 10000200 10000230 > ibr02_00002_reg.hex # Writeback Registers for WB1 */
  res |= Check_m400_pp_0_ibr02_check_0_d();          /* dump_reg 10000300 10000330 > ibr02_00003_reg.hex # Writeback Registers for WB2 */
  res |= Check_m400_pp_0_ibr02_check_0_e();          /* dump_reg 10001000 100010b8 > ibr02_00004_reg.hex # Management registers */
  /* COMMENT */                                      /* # */
  ...
  /* COMMENT */                                      /* #- Dump */
  res |= Check_m400_pp_0_ibr02_check_0_f();          /* dump_reg 10000000 10000058 > ibr02_00010_reg.hex # Frame registers */
  res |= Check_m400_pp_0_ibr02_check_0_g();          /* dump_reg 10000100 10000130 > ibr02_00011_reg.hex # Writeback Registers for WB0 */
  res |= Check_m400_pp_0_ibr02_check_0_h();          /* dump_reg 10000200 10000230 > ibr02_00012_reg.hex # Writeback Registers for WB1 */
  res |= Check_m400_pp_0_ibr02_check_0_i();          /* dump_reg 10000300 10000330 > ibr02_00013_reg.hex # Writeback Registers for WB2 */
  res |= Check_m400_pp_0_ibr02_check_0_j();          /* dump_reg 10001000 100010b8 > ibr02_00014_reg.hex # Management registers */
  /* COMMENT */                                      /* # */
  ...
  /* COMMENT */                                      /* #- Dump */
  res |= Check_m400_pp_0_ibr02_check_0_k();          /* dump_reg 10000000 10000058 > ibr02_00020_reg.hex # Frame registers */
  res |= Check_m400_pp_0_ibr02_check_0_l();          /* dump_reg 10000100 10000130 > ibr02_00021_reg.hex # Writeback Registers for WB0 */
  res |= Check_m400_pp_0_ibr02_check_0_m();          /* dump_reg 10000200 10000230 > ibr02_00022_reg.hex # Writeback Registers for WB1 */
  res |= Check_m400_pp_0_ibr02_check_0_n();          /* dump_reg 10000300 10000330 > ibr02_00023_reg.hex # Writeback Registers for WB2 */
  res |= Check_m400_pp_0_ibr02_check_0_o();          /* dump_reg 10001000 100010b8 > ibr02_00024_reg.hex # Management registers */
...
int Check_m400_pp_0_ibr02_check_0_a () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_a.data_10000000,1,0,0x0,0x58);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_b () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_b.data_10000100,1,0,0x100,0x130);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_c () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_c.data_10000200,1,0,0x200,0x230);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_d () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_d.data_10000300,1,0,0x300,0x330);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_e () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_e.data_10001000,1,0,0x1000,0x10b8);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_f () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_f.data_10000000,1,0,0x0,0x58);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_g () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_g.data_10000100,1,0,0x100,0x130);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_h () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_h.data_10000200,1,0,0x200,0x230);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_i () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_i.data_10000300,1,0,0x300,0x330);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_j () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_j.data_10001000,1,0,0x1000,0x10b8);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_k () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_k.data_10000000,1,0,0x0,0x58);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_l () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_l.data_10000100,1,0,0x100,0x130);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_m () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_m.data_10000200,1,0,0x200,0x230);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_n () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_n.data_10000300,1,0,0x300,0x330);
  return res;
};

int Check_m400_pp_0_ibr02_check_0_o () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr02_check_0_o.data_10001000,1,0,0x1000,0x10b8);
  return res;
};
