...
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_pp_0_GCxx04_check_0_a.h"
#include "m400_pp_0_GCxx04_check_0_b.h"
#include "m400_pp_0_GCxx04_mem_0.h"

int Check_m400_pp_0_GCxx04_check_0_a ();
int Check_m400_pp_0_GCxx04_check_0_b (struct t_m400_pp_0_GCxx04_mem_0 *p);

int RunMaliTest_m400_pp_0_GCxx04_part0 (void);
int RunMaliTest_m400_pp_0_GCxx04_part1 (void);

static volatile struct t_m400_pp_0_GCxx04_mem_0 *malidata_0;
static int mali_step;

int RunMaliTest_m400_pp_0_GCxx04 (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_pp_0_GCxx04_part0();
    case 1  : return RunMaliTest_m400_pp_0_GCxx04_part1();
    default : return 0;
  };
};
...
int RunMaliTest_m400_pp_0_GCxx04_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_pp_0_GCxx04\n");
  ...
  malidata_0 = (struct t_m400_pp_0_GCxx04_mem_0 *)Mali_LdMem(&m400_pp_0_GCxx04_mem_0,sizeof(struct t_m400_pp_0_GCxx04_mem_0),(int)m400_pp_0_GCxx04_mem_0.ttb_first);
...
int RunMaliTest_m400_pp_0_GCxx04_part1 (void) {
  ...
  res |= Check_m400_pp_0_GCxx04_check_0_a();         /* dump_reg 1000102c 1000103c > GCxx04_00000_irq.hex */
  /* SEE BELOW */                                    /* dump_mem 00004060 00006060 > GCxx04_00000_fb.hex */
  res |= Check_m400_pp_0_GCxx04_check_0_b(malidata_0);
...
int Check_m400_pp_0_GCxx04_check_0_a () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_GCxx04_check_0_a.data_10001020,1,0,0x102c,0x103c);
  return res;
};

int Check_m400_pp_0_GCxx04_check_0_b (struct t_m400_pp_0_GCxx04_mem_0 *p) {
  struct t_CheckData_m400_pp_0_GCxx04_check_0_b *r = &CheckData_m400_pp_0_GCxx04_check_0_b;
  int res = 0;
