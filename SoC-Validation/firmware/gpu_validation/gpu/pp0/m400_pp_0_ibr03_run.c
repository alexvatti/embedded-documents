...
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_pp_0_ibr03_check_0_a.h"
#include "m400_pp_0_ibr03_check_0_b.h"
#include "m400_pp_0_ibr03_check_0_c.h"
#include "m400_pp_0_ibr03_check_0_d.h"
#include "m400_pp_0_ibr03_check_0_e.h"
#include "m400_pp_0_ibr03_check_0_f.h"
#include "m400_pp_0_ibr03_check_0_g.h"
#include "m400_pp_0_ibr03_check_0_h.h"
#include "m400_pp_0_ibr03_check_0_i.h"
#include "m400_pp_0_ibr03_check_0_j.h"

int Check_m400_pp_0_ibr03_check_0_a ();
int Check_m400_pp_0_ibr03_check_0_b ();
int Check_m400_pp_0_ibr03_check_0_c ();
int Check_m400_pp_0_ibr03_check_0_d ();
int Check_m400_pp_0_ibr03_check_0_e ();
int Check_m400_pp_0_ibr03_check_0_f ();
int Check_m400_pp_0_ibr03_check_0_g ();
int Check_m400_pp_0_ibr03_check_0_h ();
int Check_m400_pp_0_ibr03_check_0_i ();
int Check_m400_pp_0_ibr03_check_0_j ();

int RunMaliTest_m400_pp_0_ibr03_part0 (void);

static int mali_step;

int RunMaliTest_m400_pp_0_ibr03 (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_pp_0_ibr03_part0();
    default : return 0;
  };
};
...
int RunMaliTest_m400_pp_0_ibr03_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_pp_0_ibr03\n");
  ...
  /* COMMENT */                                      /* # Dump them */
  /* COMMENT */                                      /* #Frame registers */
  res |= Check_m400_pp_0_ibr03_check_0_a();          /* dump_reg 10000000 10000050 > ibr03_00000_reg.hex */
  /* COMMENT */                                      /* #Writeback Registers for WB0 */
  res |= Check_m400_pp_0_ibr03_check_0_b();          /* dump_reg 10000100 10000130 > ibr03_00001_reg.hex */
  /* COMMENT */                                      /* #Writeback Registers for WB1 */
  res |= Check_m400_pp_0_ibr03_check_0_c();          /* dump_reg 10000200 10000230 > ibr03_00002_reg.hex */
  /* COMMENT */                                      /* #Writeback Registers for WB2 */
  res |= Check_m400_pp_0_ibr03_check_0_d();          /* dump_reg 10000300 10000330 > ibr03_00003_reg.hex */
  /* COMMENT */                                      /* #Management registers */
  res |= Check_m400_pp_0_ibr03_check_0_e();          /* dump_reg 10001000 100010b0 > ibr03_00004_reg.hex */
  ...
  /* COMMENT */                                      /* # Dump again */
  /* COMMENT */                                      /* #Frame registers */
  res |= Check_m400_pp_0_ibr03_check_0_f();          /* dump_reg 10000000 10000050 > ibr03_00005_reg.hex */
  /* COMMENT */                                      /* #Writeback Registers for WB0 */
  res |= Check_m400_pp_0_ibr03_check_0_g();          /* dump_reg 10000100 10000130 > ibr03_00006_reg.hex */
  /* COMMENT */                                      /* #Writeback Registers for WB1 */
  res |= Check_m400_pp_0_ibr03_check_0_h();          /* dump_reg 10000200 10000230 > ibr03_00007_reg.hex */
  /* COMMENT */                                      /* #Writeback Registers for WB2 */
  res |= Check_m400_pp_0_ibr03_check_0_i();          /* dump_reg 10000300 10000330 > ibr03_00008_reg.hex */
  /* COMMENT */                                      /* #Management registers */
  res |= Check_m400_pp_0_ibr03_check_0_j();          /* dump_reg 10001000 100010b0 > ibr03_00009_reg.hex */
...
int Check_m400_pp_0_ibr03_check_0_a () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_a.data_10000000,1,0,0x0,0x50);
  return res;
};

int Check_m400_pp_0_ibr03_check_0_b () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_b.data_10000100,1,0,0x100,0x130);
  return res;
};

int Check_m400_pp_0_ibr03_check_0_c () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_c.data_10000200,1,0,0x200,0x230);
  return res;
};

int Check_m400_pp_0_ibr03_check_0_d () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_d.data_10000300,1,0,0x300,0x330);
  return res;
};

int Check_m400_pp_0_ibr03_check_0_e () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_e.data_10001000,1,0,0x1000,0x10b0);
  return res;
};

int Check_m400_pp_0_ibr03_check_0_f () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_f.data_10000000,1,0,0x0,0x50);
  return res;
};

int Check_m400_pp_0_ibr03_check_0_g () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_g.data_10000100,1,0,0x100,0x130);
  return res;
};

int Check_m400_pp_0_ibr03_check_0_h () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_h.data_10000200,1,0,0x200,0x230);
  return res;
};

int Check_m400_pp_0_ibr03_check_0_i () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_i.data_10000300,1,0,0x300,0x330);
  return res;
};

int Check_m400_pp_0_ibr03_check_0_j () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_ibr03_check_0_j.data_10001000,1,0,0x1000,0x10b0);
  return res;
};
