...
* Release   : $State: Exp $
*-----------------------------------------------------------------------------*/
struct t_CheckData_m400_pp_0_FAxx_check_0_b {
  unsigned int data_00004050[1004];
  ...
  unsigned int data_0000c000[20];
};
extern struct t_CheckData_m400_pp_0_FAxx_check_0_b CheckData_m400_pp_0_FAxx_check_0_b;
