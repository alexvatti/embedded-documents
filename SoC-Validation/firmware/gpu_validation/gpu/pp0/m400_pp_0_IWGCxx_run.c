...
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_pp_0_IWGCxx_check_0_a.h"
#include "m400_pp_0_IWGCxx_check_0_b.h"
#include "m400_pp_0_IWGCxx_mem_0.h"

int Check_m400_pp_0_IWGCxx_check_0_a ();
int Check_m400_pp_0_IWGCxx_check_0_b (struct t_m400_pp_0_IWGCxx_mem_0 *p);

int RunMaliTest_m400_pp_0_IWGCxx_part0 (void);
int RunMaliTest_m400_pp_0_IWGCxx_part1 (void);

static volatile struct t_m400_pp_0_IWGCxx_mem_0 *malidata_0;
static int mali_step;

int RunMaliTest_m400_pp_0_IWGCxx (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_pp_0_IWGCxx_part0();
    case 1  : return RunMaliTest_m400_pp_0_IWGCxx_part1();
    default : return 0;
  };
};
...
int RunMaliTest_m400_pp_0_IWGCxx_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_pp_0_IWGCxx\n");

  Mali_Reset();                                      /* reset */
  /* SEE BELOW */                                    /* load_mem IWGCxx_00000.hex */
  /* Parsed hex file. Will pagetables will be setup when frame render start detected */

  Mali_WrReg(0x1,0x0,0x0,0x0000c080);                /* writereg 10000000 0000c080 */
  Mali_WrReg(0x1,0x0,0x4,0x00000040);                /* writereg 10000004 00000040 */
  Mali_WrReg(0x1,0x0,0x8,0x0000e0c0);                /* writereg 10000008 0000e0c0 */
  ...
  Mali_WrReg(0x1,0x0,0x124,0x00000001);              /* writereg 10000124 00000001 */
  Mali_WrReg(0x1,0x0,0x128,0x00003800);              /* writereg 10000128 00003800 */
  /* Detected Frame Start. Initialising memory*/     /* writereg 1000100c 00000040 */
  malidata_0 = (struct t_m400_pp_0_IWGCxx_mem_0 *)Mali_LdMem(&m400_pp_0_IWGCxx_mem_0,sizeof(struct t_m400_pp_0_IWGCxx_mem_0),(int)m400_pp_0_IWGCxx_mem_0.ttb_first);
...
int RunMaliTest_m400_pp_0_IWGCxx_part1 (void) {
  ...
  res |= Check_m400_pp_0_IWGCxx_check_0_a();         /* dump_reg 1000102C 1000103c > IWGCxx_00000_irq.hex */
  /* SEE BELOW */                                    /* dump_mem 4060 0000c060 > IWGCxx_00000_fb.hex */
  res |= Check_m400_pp_0_IWGCxx_check_0_b(malidata_0);
...
int Check_m400_pp_0_IWGCxx_check_0_a () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_0_IWGCxx_check_0_a.data_10001020,1,0,0x102c,0x103c);
  return res;
};

int Check_m400_pp_0_IWGCxx_check_0_b (struct t_m400_pp_0_IWGCxx_mem_0 *p) {
  struct t_CheckData_m400_pp_0_IWGCxx_check_0_b *r = &CheckData_m400_pp_0_IWGCxx_check_0_b;
  int res = 0;
  ...
  res |= Mali_MemCmp(p->data_0000c000, 0x0000c000, r->data_0000c000, 0, 0x018);
