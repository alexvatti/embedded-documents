...
* Release   : $State: Exp $
*-----------------------------------------------------------------------------*/
struct t_CheckData_m400_pp_3_IWGCxx_check_0_b {
  ...
  unsigned int data_0000c000[24];
};
extern struct t_CheckData_m400_pp_3_IWGCxx_check_0_b CheckData_m400_pp_3_IWGCxx_check_0_b;
