...
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_pp_1_FAxx_check_0_a.h"
#include "m400_pp_1_FAxx_check_0_b.h"
#include "m400_pp_1_FAxx_mem_0.h"

int Check_m400_pp_1_FAxx_check_0_a ();
int Check_m400_pp_1_FAxx_check_0_b (struct t_m400_pp_1_FAxx_mem_0 *p);

int RunMaliTest_m400_pp_1_FAxx_part0 (void);
int RunMaliTest_m400_pp_1_FAxx_part1 (void);

static volatile struct t_m400_pp_1_FAxx_mem_0 *malidata_0;
static int mali_step;

int RunMaliTest_m400_pp_1_FAxx (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_pp_1_FAxx_part0();
    case 1  : return RunMaliTest_m400_pp_1_FAxx_part1();
    default : return 0;
  };
};
...
int RunMaliTest_m400_pp_1_FAxx_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_pp_1_FAxx\n");

  Mali_Reset();                                      /* reset */
  /* SEE BELOW */                                    /* load_mem FAxx_00000.hex */
  /* Parsed hex file. Will pagetables will be setup when frame render start detected */

  Mali_WrReg(0x1,0x1,0x0,0x0000c060);                /* writereg 10010000 0000c060 */
  Mali_WrReg(0x1,0x1,0x4,0x00000040);                /* writereg 10010004 00000040 */
  Mali_WrReg(0x1,0x1,0x8,0x0000d080);                /* writereg 10010008 0000d080 */
  ...
  Mali_WrReg(0x1,0x1,0x104,0x00004050);              /* writereg 10010104 00004050 */
  ...
  malidata_0 = (struct t_m400_pp_1_FAxx_mem_0 *)Mali_LdMem(&m400_pp_1_FAxx_mem_0,sizeof(struct t_m400_pp_1_FAxx_mem_0),(int)m400_pp_1_FAxx_mem_0.ttb_first);
...
int RunMaliTest_m400_pp_1_FAxx_part1 (void) {
  ...
  res |= Check_m400_pp_1_FAxx_check_0_a();           /* dump_reg 1001102C 1001103c > FAxx_00000_irq.hex */
  /* SEE BELOW */                                    /* dump_mem 4050 0000c050 > FAxx_00000_fb.hex */
  res |= Check_m400_pp_1_FAxx_check_0_b(malidata_0);
...
int Check_m400_pp_1_FAxx_check_0_a () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_1_FAxx_check_0_a.data_10011020,1,1,0x102c,0x103c);
  return res;
};

int Check_m400_pp_1_FAxx_check_0_b (struct t_m400_pp_1_FAxx_mem_0 *p) {
  struct t_CheckData_m400_pp_1_FAxx_check_0_b *r = &CheckData_m400_pp_1_FAxx_check_0_b;
  int res = 0;
