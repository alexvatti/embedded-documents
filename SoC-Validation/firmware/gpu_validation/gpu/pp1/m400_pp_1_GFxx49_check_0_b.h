...
* Release   : $State: Exp $
*-----------------------------------------------------------------------------*/
struct t_CheckData_m400_pp_1_GFxx49_check_0_b {
  unsigned int data_00004380[800];
  ...
  unsigned int data_00010000[224];
};
extern struct t_CheckData_m400_pp_1_GFxx49_check_0_b CheckData_m400_pp_1_GFxx49_check_0_b;
