...
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_pp_1_IWGCxx_check_0_a.h"
#include "m400_pp_1_IWGCxx_check_0_b.h"
#include "m400_pp_1_IWGCxx_mem_0.h"

int Check_m400_pp_1_IWGCxx_check_0_a ();
int Check_m400_pp_1_IWGCxx_check_0_b (struct t_m400_pp_1_IWGCxx_mem_0 *p);

int RunMaliTest_m400_pp_1_IWGCxx_part0 (void);
int RunMaliTest_m400_pp_1_IWGCxx_part1 (void);

static volatile struct t_m400_pp_1_IWGCxx_mem_0 *malidata_0;
static int mali_step;

int RunMaliTest_m400_pp_1_IWGCxx (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_pp_1_IWGCxx_part0();
    case 1  : return RunMaliTest_m400_pp_1_IWGCxx_part1();
    default : return 0;
  };
};
...
int RunMaliTest_m400_pp_1_IWGCxx_part0 (void) {
  ...
  Mali_WrReg(0x1,0x1,0x124,0x00000001);              /* writereg 10010124 00000001 */
  Mali_WrReg(0x1,0x1,0x128,0x00003800);              /* writereg 10010128 00003800 */
  /* Detected Frame Start. Initialising memory*/     /* writereg 1001100c 00000040 */
  malidata_0 = (struct t_m400_pp_1_IWGCxx_mem_0 *)Mali_LdMem(&m400_pp_1_IWGCxx_mem_0,sizeof(struct t_m400_pp_1_IWGCxx_mem_0),(int)m400_pp_1_IWGCxx_mem_0.ttb_first);
...
int RunMaliTest_m400_pp_1_IWGCxx_part1 (void) {
  ...
  res |= Check_m400_pp_1_IWGCxx_check_0_a();         /* dump_reg 1001102C 1001103c > IWGCxx_00000_irq.hex */
  /* SEE BELOW */                                    /* dump_mem 4060 0000c060 > IWGCxx_00000_fb.hex */
  res |= Check_m400_pp_1_IWGCxx_check_0_b(malidata_0);
...
int Check_m400_pp_1_IWGCxx_check_0_a () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_1_IWGCxx_check_0_a.data_10011020,1,1,0x102c,0x103c);
  return res;
};

int Check_m400_pp_1_IWGCxx_check_0_b (struct t_m400_pp_1_IWGCxx_mem_0 *p) {
  struct t_CheckData_m400_pp_1_IWGCxx_check_0_b *r = &CheckData_m400_pp_1_IWGCxx_check_0_b;
  int res = 0;
