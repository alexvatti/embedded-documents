...
* Release   : $State: Exp $
*-----------------------------------------------------------------------------*/
struct t_CheckData_m400_pp_1_FTxx_check_0_b {
  unsigned int data_00006a40[368];
  ...
  unsigned int data_0000e000[656];
};
extern struct t_CheckData_m400_pp_1_FTxx_check_0_b CheckData_m400_pp_1_FTxx_check_0_b;
