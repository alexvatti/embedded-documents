...
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_pp_1_FTxx_check_0_a.h"
#include "m400_pp_1_FTxx_check_0_b.h"
#include "m400_pp_1_FTxx_mem_0.h"

int Check_m400_pp_1_FTxx_check_0_a ();
int Check_m400_pp_1_FTxx_check_0_b (struct t_m400_pp_1_FTxx_mem_0 *p);

int RunMaliTest_m400_pp_1_FTxx_part0 (void);
int RunMaliTest_m400_pp_1_FTxx_part1 (void);

static volatile struct t_m400_pp_1_FTxx_mem_0 *malidata_0;
static int mali_step;

int RunMaliTest_m400_pp_1_FTxx (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_pp_1_FTxx_part0();
    case 1  : return RunMaliTest_m400_pp_1_FTxx_part1();
    default : return 0;
  };
};
...
int RunMaliTest_m400_pp_1_FTxx_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_pp_1_FTxx\n");

  Mali_Reset();                                      /* reset */
  /* SEE BELOW */                                    /* load_mem FTxx_00000.hex */
  /* Parsed hex file. Will pagetables will be setup when frame render start detected */

  Mali_WrReg(0x1,0x1,0x0,0x0000ea60);                /* writereg 10010000 0000ea60 */
  Mali_WrReg(0x1,0x1,0x4,0x00000040);                /* writereg 10010004 00000040 */
  Mali_WrReg(0x1,0x1,0x8,0x00013ac0);                /* writereg 10010008 00013ac0 */
  Mali_WrReg(0x1,0x1,0xc,0x00000001);                /* writereg 1001000c 00000001 */
  Mali_WrReg(0x1,0x1,0x30,0x0000fa80);               /* writereg 10010030 0000fa80 */
  ...
  Mali_WrReg(0x1,0x1,0x104,0x00006a40);              /* writereg 10010104 00006a40 */
  ...
  malidata_0 = (struct t_m400_pp_1_FTxx_mem_0 *)Mali_LdMem(&m400_pp_1_FTxx_mem_0,sizeof(struct t_m400_pp_1_FTxx_mem_0),(int)m400_pp_1_FTxx_mem_0.ttb_first);
...
int RunMaliTest_m400_pp_1_FTxx_part1 (void) {
  ...
  res |= Check_m400_pp_1_FTxx_check_0_a();           /* dump_reg 1001102C 1001103c > FTxx_00000_irq.hex */
  /* SEE BELOW */                                    /* dump_mem 6a40 0000ea40 > FTxx_00000_fb.hex */
  res |= Check_m400_pp_1_FTxx_check_0_b(malidata_0);
...
int Check_m400_pp_1_FTxx_check_0_a () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_pp_1_FTxx_check_0_a.data_10011020,1,1,0x102c,0x103c);
  return res;
};

int Check_m400_pp_1_FTxx_check_0_b (struct t_m400_pp_1_FTxx_mem_0 *p) {
  struct t_CheckData_m400_pp_1_FTxx_check_0_b *r = &CheckData_m400_pp_1_FTxx_check_0_b;
  int res = 0;
