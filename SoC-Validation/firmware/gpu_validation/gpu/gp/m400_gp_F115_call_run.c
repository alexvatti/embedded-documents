...
#include "m400_gp_F115_call_mem_0.h"

int Check_m400_gp_F115_call_check_0_a (struct t_m400_gp_F115_call_mem_0 *p);

int RunMaliTest_m400_gp_F115_call_part0 (void);
int RunMaliTest_m400_gp_F115_call_part1 (void);

static volatile struct t_m400_gp_F115_call_mem_0 *malidata_0;
static int mali_step;

int RunMaliTest_m400_gp_F115_call (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_gp_F115_call_part0();
    case 1  : return RunMaliTest_m400_gp_F115_call_part1();
    default : return 0;
  };
};
...
int RunMaliTest_m400_gp_F115_call_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_gp_F115_call\n");
  ...
  malidata_0 = (struct t_m400_gp_F115_call_mem_0 *)Mali_LdMem(&m400_gp_F115_call_mem_0,sizeof(struct t_m400_gp_F115_call_mem_0),(int)m400_gp_F115_call_mem_0.ttb_first);
...
int RunMaliTest_m400_gp_F115_call_part1 (void) {
  ...
  res |= Check_m400_gp_F115_call_check_0_a(malidata_0);
...
int Check_m400_gp_F115_call_check_0_a (struct t_m400_gp_F115_call_mem_0 *p) {
  struct t_CheckData_m400_gp_F115_call_check_0_a *r = &CheckData_m400_gp_F115_call_check_0_a;
  int res = 0;
