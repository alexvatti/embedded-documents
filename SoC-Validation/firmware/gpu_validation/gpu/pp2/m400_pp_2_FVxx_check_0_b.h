...
* Release   : $State: Exp $
*-----------------------------------------------------------------------------*/
struct t_CheckData_m400_pp_2_FVxx_check_0_b {
  unsigned int data_00007080[992];
  ...
  unsigned int data_0000f000[32];
};
extern struct t_CheckData_m400_pp_2_FVxx_check_0_b CheckData_m400_pp_2_FVxx_check_0_b;
