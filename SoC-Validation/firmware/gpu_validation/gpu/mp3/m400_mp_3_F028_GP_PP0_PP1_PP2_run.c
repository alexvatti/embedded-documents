...
* from ARM Limited.
*
* Modified  : $Date: 2013/05/14 11:58:22 $
* Revision  : $Revision: 1.1 $
* Release   : $State: Exp $
*-----------------------------------------------------------------------------*/
#include "MaliFns.h"
#include "m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_a.h"
#include "m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_b.h"
#include "m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_c.h"
#include "m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_d.h"
#include "m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_e.h"
#include "m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_f.h"
#include "m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_g.h"
#include "m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_h.h"
#include "m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0.h"

int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_a (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p);
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_b (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p);
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_c ();
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_d (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p);
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_e ();
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_f (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p);
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_g ();
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_h (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p);

int RunMaliTest_m400_mp_3_F028_GP_PP0_PP1_PP2_part0 (void);
int RunMaliTest_m400_mp_3_F028_GP_PP0_PP1_PP2_part1 (void);

static volatile struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *malidata_0;
static int mali_step;

int RunMaliTest_m400_mp_3_F028_GP_PP0_PP1_PP2 (int init) {
  if (init) { mali_step = 0; };
  switch (mali_step) {
    case 0  : return RunMaliTest_m400_mp_3_F028_GP_PP0_PP1_PP2_part0();
    case 1  : return RunMaliTest_m400_mp_3_F028_GP_PP0_PP1_PP2_part1();
    default : return 0;
  };
};
...
int RunMaliTest_m400_mp_3_F028_GP_PP0_PP1_PP2_part0 (void) {
  int res = 0;
  printf("RUNNING TEST: m400_mp_3_F028_GP_PP0_PP1_PP2\n");
  ...
  /* SEE BELOW */                                    /* load_mem GTxx09_00000.hex */
  /* Parsed hex file. Will pagetables will be setup when frame render start detected */

  /* SEE BELOW */                                    /* load_mem GFxx01_00024.hex */
  /* Parsed hex file. Will pagetables will be setup when frame render start detected */
  ...
  malidata_0 = (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *)Mali_LdMem(&m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0,sizeof(struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0),(int)m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0.ttb_first);
...
/*  Mali_InitPerfCounters(); */
  ...
  Mali_WrReg(0x1,0x1,0x0,0x200020c0);                /* writereg 10010000 200020c0 # render_job */
  Mali_WrReg(0x1,0x1,0x4,0x20000040);                /* writereg 10010004 20000040 # render_job */
  Mali_WrReg(0x1,0x1,0x8,0x200022c0);                /* writereg 10010008 200022c0 # render_job */
  Mali_WrReg(0x1,0x1,0x100,0x00000002);              /* writereg 10010100 00000002 # render_job */
  Mali_WrReg(0x1,0x1,0x104,0x200000c0);              /* writereg 10010104 200000c0 # render_job */
  Mali_WrReg(0x1,0x1,0x114,0x00000010);              /* writereg 10010114 00000010 # render_job */
  ...
  Mali_WrReg(0x1,0x2,0x0,0x300010c0);                /* writereg 10020000 300010c0 # render_job */
  Mali_WrReg(0x1,0x2,0x4,0x30000040);                /* writereg 10020004 30000040 # render_job */
  Mali_WrReg(0x1,0x2,0x8,0x30001140);                /* writereg 10020008 30001140 # render_job */
  Mali_WrReg(0x1,0x2,0x18,0xaaffffff);               /* writereg 10020018 aaffffff # render_job */
  Mali_WrReg(0x1,0x2,0x1c,0xaaffffff);               /* writereg 1002001c aaffffff # render_job */
  Mali_WrReg(0x1,0x2,0x20,0xaaffffff);               /* writereg 10020020 aaffffff # render_job */
  Mali_WrReg(0x1,0x2,0x24,0xaaffffff);               /* writereg 10020024 aaffffff # render_job */
  Mali_WrReg(0x1,0x2,0x100,0x00000002);              /* writereg 10020100 00000002 # render_job */
  Mali_WrReg(0x1,0x2,0x104,0x300000c0);              /* writereg 10020104 300000c0 # render_job */
  Mali_WrReg(0x1,0x2,0x108,0x00000003);              /* writereg 10020108 00000003 # render_job */
  Mali_WrReg(0x1,0x2,0x114,0x00000010);              /* writereg 10020114 00000010 # render_job */
  Mali_WrReg(0x1,0x2,0x100c,0x00000040);             /* writereg 1002100c 00000040 # render_job */
  mali_step++;                                       /* wait irq 00010007 00010007 */
...
int RunMaliTest_m400_mp_3_F028_GP_PP0_PP1_PP2_part1 (void) {
  ...
  have_interrupts = Mali_InterruptCheck(0x00010007,0x00010007);
  if (!have_interrupts) {
   return 255;
  }
  ...
  res |= Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_a(malidata_0);

  /* SEE BELOW */                                    /* dump_mem 00003380 00049880 > plbu_scissor02_elements_12_dump_plbu_heap.hex */
  res |= Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_b(malidata_0);
  ...
  res |= Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_c();

  /* SEE BELOW */                                    /* dump_mem 100000c0 100020c0 > GTxx01_00000_fb.hex */
  res |= Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_d(malidata_0);
  ...
  res |= Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_e();

  /* SEE BELOW */                                    /* dump_mem 200000c0 200020c0 > GTxx09_00000_fb.hex */
  res |= Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_f(malidata_0);
  ...
  /* COMMENT */                                      /* # PP2 */
  Mali_DisplayReg(1,2,0x102c);                       /* dump_reg 1002102C 1002103c */
  Mali_DisplayReg(1,2,0x1030);
  Mali_DisplayReg(1,2,0x1034);
  Mali_DisplayReg(1,2,0x1038);
  
  /* SEE BELOW */                                    /* dump_reg 1002102C 1002103c > GFxx01_00024_irq.hex */
  res |= Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_g();

  /* SEE BELOW */                                    /* dump_mem 300000c0 300010c0 > GFxx01_00024_fb.hex */
  res |= Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_h(malidata_0);

  Mali_WrReg(0x1,0x2,0x1024,0x00000001);             /* writereg 10021024 00000001 #clear irq */
  Mali_WrReg(0x1,0x2,0x100c,0x00000008);             /* writereg 1002100c 00000008 # flushcache */
...
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_a (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p) {
  struct t_CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_a *r = &CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_a;
  int res = 0;
...
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_b (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p) {
  struct t_CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_b *r = &CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_b;
  int res = 0;
...
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_c () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_c.data_10001020,1,0,0x1030,0x103c);
  return res;
};

int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_d (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p) {
  struct t_CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_d *r = &CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_d;
  int res = 0;
...
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_e () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_e.data_10011020,1,1,0x1030,0x103c);
  return res;
};

int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_f (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p) {
  struct t_CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_f *r = &CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_f;
  int res = 0;
  Mali_Message("Performing data check of 8192 bytes\n");

  res |= Mali_MemCmp(p->data_20000000, 0x200000c0, r->data_200000c0, 0, 0x3d0);
  res |= Mali_MemCmp(p->data_20001000, 0x20001000, r->data_20001000, 0, 0x400);
  res |= Mali_MemCmp(p->data_20002000, 0x20002000, r->data_20002000, 0, 0x030);
  /* Return -1 if a compare fail */
  if (res) { return -1; };
  Mali_Message("Check okay \n");
  return 0;
...
int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_g () {
  int res = 0;
  res |= Mali_CompareRegs(CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_g.data_10021020,1,2,0x1030,0x103c);
  return res;
};

int Check_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_h (struct t_m400_mp_3_F028_GP_PP0_PP1_PP2_mem_0 *p) {
  struct t_CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_h *r = &CheckData_m400_mp_3_F028_GP_PP0_PP1_PP2_check_0_h;
  int res = 0;
  Mali_Message("Performing data check of 4096 bytes\n");

  res |= Mali_MemCmp(p->data_30000000, 0x300000c0, r->data_300000c0, 0, 0x3d0);
  res |= Mali_MemCmp(p->data_30001000, 0x30001000, r->data_30001000, 0, 0x030);
  /* Return -1 if a compare fail */
  if (res) { return -1; };
  Mali_Message("Check okay \n");
  return 0;
