...
struct dram_controller_timing {
	u32 ck;
	u32 ps;
};

/* */
struct dram_controller_cl_cwl_timing {
	u32 CL;
	u32 CWL;
	u32 tCKmin;  /* in ps */
	u32 tCKmax;  /* in ps */
...
struct dram_controller_para {
	...
	struct dram_controller_cl_cwl_timing *cl_cwl_table;
	...
	u32 tDLLK; /* in nCK */
	struct dram_controller_timing tRTP;
	struct dram_controller_timing tWTR;
	u32 tWR;   /* in nCK */
	u32 tMRD;  /* in nCK */
	struct dram_controller_timing tMOD;
	u32 tRCD;  /* in ps */
	u32 tRP;   /* in ps */
	u32 tRC;   /* in ps */
	u32 tCCD;  /* in nCK */
	struct dram_controller_timing tRRD;
	u32 tFAW;  /* in ps */

	/* calibration timing */
	/* struct dram_sun9i_timing tZQinit; */
	struct dram_controller_timing tZQoper;
	struct dram_controller_timing tZQCS;

	/* reset timing */
	/* struct dram_sun9i_timing tXPR; */

	/* self-refresh timings */
	struct dram_controller_timing tXS;
	u32 tXSDLL; /* in nCK */
	/* struct dram_sun9i_timing tCKESR; */
	struct dram_controller_timing tCKSRE;
	struct dram_controller_timing tCKSRX;

	/* power-down timings */
	struct dram_controller_timing tXP;
	struct dram_controller_timing tXPDLL;
	struct dram_controller_timing tCKE;
