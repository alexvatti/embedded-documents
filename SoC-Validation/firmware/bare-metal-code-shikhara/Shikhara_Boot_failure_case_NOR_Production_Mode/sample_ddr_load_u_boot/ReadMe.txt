...
Objective: Shikhara Boot failure case[NOR Production Mode(0X000)) , will do the ddr3 init, load u-boot(from NOR) to DDR3
=======================================================================================================================
...
4.startup.s, Please considet the change
...
Procedure:
==========
1. Get the licence , make sure it is in working condition
2. Load ddr init code , then followed by u-boot code

3. In order to flash (Boot strap code) to NOR Flash

1. flash_start
2. protect off all /flinfo (RO)
3. erase 0xc0000000 0xc001ffff
4. loadx 0x100 (boot_strap_code code, bin file)
5. cp.b 0x100 0xc0000000 length(hexa)



6.loadx 0x100 (u-boot, bin file)
7.cp.b 0x100 0xc0040000 length(hexa) (erase 0xc0040000 0xc005ffff)


8.boot strap mode(0000) ,power off , DS-5 Disconnect , UART-0 Connection,
9. power on

------ : Welcome to Shikhara Project... 
DDR init completed
