Objective:SMC -NOR Write and Read and verify the fixed pattern
================================================================

Step 0:
=====
SMC-NOR Memory Map in Shikhara


Name    		Size               Start Address 	End Address
NOR_MEM_0  		64MB  		   0xC0000000 		0xC3FFFFFF [ note*****:chip select 1 and interface 0] 
...
2. chip select is cs1(chip select), instead of cs0(chip select)

smc_sram_write: 
SMC_NORFLASH_BASE_ADDR:0xC0000000 , write 0x1592 into 1024 locations ( 2 bytes each)

smc_sram_read: 
SMC_NORFLASH_BASE_ADDR:0xC0000000 , read from 1024 locations ( 2 bytes each)
