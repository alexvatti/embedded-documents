...
#if defined ARC_BITSTREAM_READER
...
#ifndef EMULATE_INTTYPES_FOR_LIBARCAVCODEC
//#   include <inttypes.h>
#else
    //typedef signed char  int8_t;
    //typedef signed short int16_t;
    //typedef signed int   int32_t;
    #if defined __MPEG_HCAC__ && !defined _STDINT_H
    	typedef signed char  int8_t;
    	typedef signed short int16_t;
    	typedef signed int   int32_t;
	...
	#else
		#define int8_t mplayer_int8_t
    	typedef signed char  int8_t;
	#endif

#if defined LIBARCAVCODEC_INTERNAL_COMPILE && !defined _STDINT_H
    typedef unsigned char  uint8_t;
    typedef unsigned short uint16_t;
    typedef unsigned int   uint32_t;
...
#   else /* other OS */
    #ifdef DEFINE_INT64_T
        typedef signed long long   int64_t;
    #endif
        typedef unsigned long long uint64_t;
#   endif /* other OS */
#endif /* LIBARCAVCODEC_INTERNAL_COMPILE */
...
#if defined(__HIGHC__) && defined(__Xmpy)

int mpyh(int,int);
#pragma intrinsic(mpyh,name=>"mpyh");

#define FASTDIV(a,b)   mpyh(a, inverse[b])
...
#if !defined __MPEG_HCAC__ && !defined __ARC_MPLAYER__
...
#if defined(__ARC_STANDALONE_) && !defined(__GNUC_)
