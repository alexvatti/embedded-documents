...
/* Need to include this to get the FILE struct when compiling with hcac
 *     - ACM 2005-08-23
 */
//#include <stdio.h>
...
#define PREV_PICT_TYPES_BUFFER_SIZE 256
    ...
    int prev_qscale;            ///< Previous scaling factor
    int first_mb_in_slice;      ///< Denotes the first mb in a 'packet'
#endif
    int qscale;                 ///< QP
...
#ifdef ARCH_ARC
    uint16_t *intra_matrix_sdm;
    uint16_t *inter_matrix_sdm;
    uint16_t *chroma_intra_matrix_sdm;
    uint16_t *chroma_inter_matrix_sdm;
#endif
...
//FIXME some prefix?
    ...
    BS_CONTEXT_TYPE last_resync_gb;    ///< used to search for the next resync marker 
