...
// 16x16 8x8 4x4 2x2 16x8 8x4 4x2 8x16 4x8 2x4
    ...
    qpel_mc_func put_qpel_pixels_tab[3][16];        // 0:16x16 1:8x8 2:16x8
    qpel_mc_func avg_qpel_pixels_tab[3][16];        // 0:16x16 1:8x8 2:16x8
    qpel_mc_func put_no_rnd_qpel_pixels_tab[3][16]; // 0:16x16 1:8x8 2:16x8

    qpel_mc_func avg_no_rnd_qpel_pixels_tab[3][16]; //NOT NEEDED
    ...
    /* libarcavcodec specialised version, to be used when dest is stored in
     * the SDM with a stride of 16. */
    void (*idct_add32)(uint8_t *dest/*align 8*/, int line_size, DCTELEM *block/*align 16*/);

    void (*idct_add64)(uint8_t *dest/*align 8*/, int line_size, DCTELEM *block/*align 16*/);
