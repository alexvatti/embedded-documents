...
#define MINIMUM_QUANTISER_INDEX					  0
#define MAXIMUM_QUANTISER_INDEX					 51

#ifdef __ENCODER_WEIGHTED_PREDICTION__
// 18 is used to allow simple accessing of the weighted reference pictures
// It is assumed there are up to 8 refs, and one decoded pic, mirrored into
// the second half of the arrays for weighted reference pictures
#define MAXIMUM_NUMBER_OF_STORED_FRAMES			 18
#else
#if defined __ARC_SHARED_BUFFER__
#define MAXIMUM_NUMBER_OF_STORED_FRAMES			 18
#else
#define MAXIMUM_NUMBER_OF_STORED_FRAMES			 17
#endif
#endif

#define MAXIMUM_NUMBER_OF_THREADS				  8
...
#ifndef CLIP
#define CLIP(low, high, x) _max(_min(high, x), low)
#endif
...
typedef unsigned short	h264_vld_state_t;
...
typedef char	h264_profile_type_t;
...
typedef char	h264_NAL_unit_type_t;
...
typedef char	h264_slice_type_t;
...
enum
{
	...
	H264_INTER_16X8				=	1,
	H264_INTER_8X16				=	2,
	H264_INTER_8X8_MULTI_REF	=	3,
	H264_INTER_8X8_ZERO_REF		=	4,
	
	H264_INTRA_BLKS				=	8,		// Mask for testing for H264_INTRA_4X4 || H264_INTRA_16X16
	H264_INTRA_4X4				=	8,
	H264_INTRA_16X16			=	8+1,
	
	H264_DIRECT					=	16,
	H264_SKIPPED				=	17,
	H264_S_INTRA_4X4			=	18,
	H264_I_PCM					=	19,
	H264_UNKNOWN_MB_TYPE		=	32
};
typedef char	h264_mb_type_t;
...
typedef char h264_8x8_partition_mode_type_t;
...
typedef unsigned char	h264_8x8_partition_direction_type_t;
...
typedef char	h264_block_shape_type_t;
...
typedef char	h264_RMPNI_type;

enum	
{
	H264_MMCO_END_OF_LOOP,
	H264_MMCO_MARK_SHORT_UNUSED,
	H264_MMCO_MARK_LONG_UNUSED,
	H264_MMCO_ASSIGN_LONG_TERM,
	H264_MMCO_MAX_LONG_INDEX,
	H264_MMCO_RESET,
	H264_MMCO_STORE_AS_LONG_TERM,
	H264_MMCO_UNKNOWN
};
typedef char	h264_MMCO_type;
...
typedef char  h264_filter_edge_type;
...
typedef char h264_picture_type;
