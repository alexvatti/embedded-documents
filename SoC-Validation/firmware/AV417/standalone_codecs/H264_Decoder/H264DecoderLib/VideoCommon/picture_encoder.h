...
public:
	void			fill		(pel_t y, pel_t u, pel_t v);
        ...
        unsigned long int       checksum_y      (void);
        unsigned long int       checksum_u      (void);
        unsigned long int       checksum_v      (void);
	...
	int				write_to_single_file (char* basename, bool writeChecksum);
