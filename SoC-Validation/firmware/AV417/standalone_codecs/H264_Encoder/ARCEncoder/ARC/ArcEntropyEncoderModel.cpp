...
#ifdef EE_DUMP
  fprintf(verif_log, "\n----------------------------------------------\n");
  fprintf(verif_log, "GENERATING CODED BLOCK PATTERN\n");
  fflush(verif_log);
#endif
...
#ifdef EE_DUMP
  fprintf(verif_log, "H264 CODED BLOCK PATTERN IS 0x%x\n", cbp);
  fprintf(verif_log, "----------------------------------------------\n");
  fflush(verif_log);
  cbp_value = cbp;
  sample_cbp = true;
...
void ArcEntropyEncoderModel::CalculateCodedBlockPatternH263(void)
{
...
#ifdef EE_DUMP 
  fprintf(verif_log, "\n----------------------------------------------\n");
  fprintf(verif_log, "MPEG4/ H263 CODED BLOCK PATTERN IS 0x%x\n", cbp);
  fprintf(verif_log, "----------------------------------------------\n");
  fflush(verif_log);
  ...
  else if ((EE_AUX_REGS[CODEC_CFG]&0x3) == 2)
  {
    ...
    //fprintf(verif_log, "H263_CBP_VALUE = 0x%x\n", h263_cbp_value);
...
#ifdef EE_DUMP        
           fprintf(verif_log, "\n----------------------------------------------\n");
           fprintf(verif_log, "DELTA QUANT WRITTEN TO ADD_UEV REG: WRITTEN = 0x%x\n", DQuant_codeword);
           fprintf(verif_log, "----------------------------------------------\n");
           fflush(verif_log);
...
#ifdef EE_DUMP        
           fprintf(verif_log, "\n----------------------------------------------\n");
           fprintf(verif_log, "EncodeCodeMBType\n");
           fprintf(verif_log, "MB_TYPE TO ADD_UEV REG: VALUE WRITTEN = 0x%x\n", mb_type);
           fflush(verif_log);
...
#ifdef EE_DUMP
    fprintf(verif_log, "MOTION VECTOR SEV VALUES FOR BLOCK_INDEX %d ARE:\n", block_index);
    fprintf(verif_log, "DIFFERENTIAL HORIZONTAL = 0x%04X\n", (differential_hor & 0xFFFF));
    fprintf(verif_log, "DIFFERENTIAL VERTICAL = 0x%04X\n", (differential_ver & 0xFFFF));
#endif
...
#ifdef EE_DUMP        
           fprintf(verif_log, "----------------------------------------------\n");
           fprintf(verif_log, "EncodeMVAndCBP\n");
           fprintf(verif_log, "MBCodingType = %d\n", MpcCurrentPtr->MBCodingType);
           fprintf(verif_log, "----------------------------------------------\n");
           fflush(verif_log);
#endif               
...
#ifdef EE_DUMP        
        fprintf(verif_log, "----------------------------------------------\n");
        fprintf(verif_log, "INTRA MODE CHROMA WRITTEN TO ADD_UEV REG: VALUE = 0x%x\n", IntraModeChroma);
        fprintf(verif_log, "----------------------------------------------\n");
        fflush(verif_log);
#endif               
...
void ArcEntropyEncoderModel::EncodeH264Coefficients(void)
{
#ifdef EE_DUMP        
   fprintf(verif_log, "\n----------------------------------------------\n");
   fprintf(verif_log, "EncodeH264Coefficients\n");
   fprintf(verif_log, "----------------------------------------------\n");
   fflush(verif_log);
#endif
   ...
   /////////////////////////////////////////////////////////
...
#ifdef EE_DUMP        
    fprintf(verif_log, "*************************\n");
    fprintf(verif_log, "Luma DC coeffs\n");
    fprintf(verif_log, "*************************\n");
    fflush(verif_log);
#endif
	...
	{
#ifdef EE_DUMP        
        fprintf(verif_log, "MBCodingType = MBCT_H264_INTRA16X16\n");
        fflush(verif_log);
#endif
		// Code DC 4X4 block
...
#ifdef EE_DUMP        
            //fprintf(verif_log, "FOR INDEX %d DC COEFF VALUE = 0x%04X\n", index, (Coeff & 0xFFFF));   
            fprintf(verif_log, "DC COEFF VALUE = 0x%04X\n", (Coeff & 0xFFFF));   
#endif
...
#ifdef EE_DUMP        
            fprintf(verif_log, "TrailingOnesSign  = %d\n", TrailingOnesSignTable[i]);
            fflush(verif_log);
		...
		if (0 != TotalCoeffs)
		{
            ...
            printf("intra16x16_dc_total_zeros  = %d\n", intra16x16_dc_total_zeros);
            fflush(verif_log);
...
#ifdef EE_DUMP        
    fprintf(verif_log, "*************************\n");
    fprintf(verif_log, "Luma AC coeffs\n");
    fprintf(verif_log, "*************************\n");
    fflush(verif_log);
    ...
    if (0 != (cbp & 15))		// ie if there *are* some LUMA AC coefficients
	{
      ...
      // Check CBP to determine whether block is part of an 8x8 block that has coefficients
...
#ifdef EE_DUMP        
                    fprintf(verif_log, "LUMA AC BLOCK NUMBER = %d\n", block_number);
                    fprintf(verif_log, "LUMA AC LOOP COUNT = %d\n", j);
                    fprintf(verif_log, "LUMA AC COEFFICIENT HAS VALUE = 0x%04X\n", Coeff);
#endif
					ProcessCoefficient();
				}
            ...
            TotalCoeffs = CoefficientCount + NumberOfTrailingOnes;
#ifdef EE_DUMP        
            fprintf(verif_log, "LUMA AC: TotalCoeffs = %d\n", TotalCoeffs);
            fprintf(verif_log, "LUMA AC: CoefficientCount = %d\n", CoefficientCount);
            fprintf(verif_log, "LUMA AC: NumberOfTrailingOnes = %d\n", NumberOfTrailingOnes);
            fflush(verif_log);
        ...
        sample_h264_coeff_token = true;
				...
				for (int i = 0; i < NumberOfTrailingOnes; i++)
				{
					...
					WRITE_ENCODED_SYMBOL("Trailing ones sign", TrailingOnesSignTable[i])
#ifdef EE_DUMP        
            fprintf(verif_log, "LUMA AC: TrailingOnesSign = %d\n", TrailingOnesSignTable[i]);
            fflush(verif_log);
...
#ifdef EE_DUMP
                fprintf(verif_log, "Luma AC block_number = %d\n",block_number);
                fprintf(verif_log, "Luma AC CoefficientCount = %d\n", CoefficientCount);
#endif
...
#ifdef EE_DUMP        
    fprintf(verif_log, "*************************\n");
    fprintf(verif_log, "Chroma DC coeffs\n");
    fprintf(verif_log, "*************************\n");
    fflush(verif_log);
#endif
	...
	if (0 != (cbp >> 4))
	{
...
#ifdef EE_DUMP        
        fprintf(verif_log, "CHROMA DC: TotalCoeffs = %d\n", TotalCoeffs);
        fprintf(verif_log, "CHROMA DC: NumberOfTrailingOnes = %d\n", NumberOfTrailingOnes);
        fflush(verif_log);
		...
		for (int i = 0; i < NumberOfTrailingOnes; i++)
		{
			...
			WRITE_ENCODED_SYMBOL("Trailing ones sign", TrailingOnesSignTable[i])
#ifdef EE_DUMP        
            fprintf(verif_log, "CHROMA DC: TrailingOnesSign = %d\n", TrailingOnesSignTable[i]);
            fflush(verif_log);
...
#ifdef EE_DUMP        
    fprintf(verif_log, "*************************\n");
    fprintf(verif_log, "Chroma AC coeffs\n");
    fprintf(verif_log, "*************************\n");
    fflush(verif_log);
#endif
...
#ifdef EE_DUMP
    fprintf(verif_log, "nl = %d\n", nl);
    fprintf(verif_log, "nu = %d\n", nu);
    fprintf(verif_log, "nc = %d\n", n);
    fflush(verif_log);
    sample_h264_nc = true;
    h264_nc = n;
    fprintf(verif_log, "h264_nc = %d\n", h264_nc);
    fflush(verif_log);
#endif
...
#ifdef EE_DUMP
    fprintf(verif_log, "\n----------------------------------------------\n");
    fprintf(verif_log, "ENCODE TOTAL COEFFICIENTS & TRAILING ONES: TABLE BEING USED = %d\n", CoeffTokenTable);
    fflush(verif_log);
#endif
...
#endif
{
    ...
    fprintf(verif_log, "\n----------------------------------------------\n");
    if (mode == 0) {
      fprintf(verif_log, "ENCODE LEVELS FOR LUMA DC\n");
    }
    else if (mode == 1) {
      fprintf(verif_log, "ENCODE LEVELS FOR LUMA AC\n");
    }
    else if (mode == 2) {
      fprintf(verif_log, "ENCODE LEVELS FOR CHROMA DC\n");
    }
    else if (mode == 3) {
      fprintf(verif_log, "ENCODE LEVELS FOR CHROMA AC\n");
    }
    fflush(verif_log);
