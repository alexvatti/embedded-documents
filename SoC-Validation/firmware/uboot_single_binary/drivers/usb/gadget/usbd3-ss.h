...
#define ANUSOC_USBD_DETECT_IRQ()	(readl(rGEVNTCOUNT0))
#define ANUSOC_USBD_CLEAR_IRQ()	do { \
					; \
				} while (0)
...
#define USBDEV3_MDWIDTH			32	// 64 by default master data bus width
...
#define CTRL_BUF_SIZE			512		//128 set by default
...
typedef union
{
	...
	struct {
		...
		unsigned rsvd29_5:13;
		unsigned keep_connect:1;
		unsigned rsvd20_11:11;
...
#define USBDEV3_EVENT_BUFFER_COUNT	128	//128 he is set by default 256
...
typedef struct
{
	...
	DEVICE_REQUEST_PTR m_oDeviceRequest;
...
/* in usbd3-ss.c */
extern unsigned int shikhara_usbd_dn_addr;
extern unsigned int shikhara_usbd_dn_cnt;
extern int DNW;
extern int shikhara_got_header;
extern int shikhara_receive_done;
