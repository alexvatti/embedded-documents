 ...
 * USBD3 SFR
 */
#define USBDEVICE3_LINK_BASE		SHIKHARA_USB3_DRD_BASE
...
//==========================
#define SHIKHARA_PHY_LINKSYSTEM		(USBDEVICE3_PHYCTRL_BASE + 0x04)
#define SHIKHARA_PHY_UTMI			(USBDEVICE3_PHYCTRL_BASE + 0x08)
#define SHIKHARA_PHY_PIPE			(USBDEVICE3_PHYCTRL_BASE + 0x0C)
#define SHIKHARA_PHY_CLKPWR		(USBDEVICE3_PHYCTRL_BASE + 0x10)
#define SHIKHARA_PHY_REG0			(USBDEVICE3_PHYCTRL_BASE + 0x14)
#define SHIKHARA_PHY_REG1			(USBDEVICE3_PHYCTRL_BASE + 0x18)
#define SHIKHARA_PHY_PARAM0		(USBDEVICE3_PHYCTRL_BASE + 0x1C)
#define SHIKHARA_PHY_PARAM1		(USBDEVICE3_PHYCTRL_BASE + 0x20)
#define SHIKHARA_PHY_TERM			(USBDEVICE3_PHYCTRL_BASE + 0x24)
#define SHIKHARA_PHY_TEST			(USBDEVICE3_PHYCTRL_BASE + 0x28)
#define SHIKHARA_PHY_ADP			(USBDEVICE3_PHYCTRL_BASE + 0x2C)
#define SHIKHARA_PHY_BATCHG		(USBDEVICE3_PHYCTRL_BASE + 0x30)
#define SHIKHARA_PHY_RESUME		(USBDEVICE3_PHYCTRL_BASE + 0x34)
#define SHIKHARA_PHY_LINK_PORT            (USBDEVICE3_PHYCTRL_BASE + 0x44)
