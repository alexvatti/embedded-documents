...
#ifndef __SHIKHARA_HDMI_H__
#define __SHIKHARA_HDMI_H__

	#define DDR_HDMI_AUDIO_ADDR	0x00040000
	#define PMU_CONFIG_ADDR		SHIKHARA_SYS_CTRL_BASEADDR + 0X0CC //PMU address to power up/down HDMI
	...
	#define HDMI_AHB_DMA_STRADDR_SET1_0		0x3620
	#define HDMI_AHB_DMA_STRADDR_SET1_1		0x3621
	#define HDMI_AHB_DMA_STRADDR_SET1_2		0x3622
	#define HDMI_AHB_DMA_STRADDR_SET1_3		0x3623
	#define HDMI_AHB_DMA_STPADDR_SET1_0		0x3624
	#define HDMI_AHB_DMA_STPADDR_SET1_1		0x3625
	#define HDMI_AHB_DMA_STPADDR_SET1_2		0x3626
	#define HDMI_AHB_DMA_STPADDR_SET1_3		0x3627
	...
	#define HDMI_MC_SWRSTREQ2			0X400A
	...
	/* HDCP Encryption Engines Registers   */                    
	#define  HDMI_A_HDCPCFG0                        0x5000 
	#define  HDMI_A_HDCPCFG1                          0x5001 
	#define  HDMI_A_HDCPOBS0                          0x5002 
	#define  HDMI_A_HDCPOBS1                          0x5003 
	...
	#define  HDMI_A_COREVERLSB                        0x5014 
	#define  HDMI_A_COREVERMSB                        0x5015 
	#define  HDMI_A_KSVMEMCTRL                        0x5016 
		                     
	#define  HDMI_HDCP_BSTATUS_0                      0x5020 
	...
	#define  HDMI_HDCP_KSV_640                        0x502A 
	#define  HDMI_HDCP_KSV_640_1                      0x502B 
	#define  HDMI_HDCP_KSV_640_2                      0x502C 
	#define  HDMI_HDCP_KSV_640_3                      0x502D 
	#define  HDMI_HDCP_KSV_640_4                      0x502E 
	#define  HDMI_HDCP_KSV_640_5                      0x502F 
	#define  HDMI_HDCP_KSV_640_6                      0x5030 
	#define  HDMI_HDCP_KSV_640_7                      0x5031 
	#define  HDMI_HDCP_KSV_640_8                      0x5032 
	#define  HDMI_HDCP_KSV_640_9                      0x5033 
	#define  HDMI_HDCP_KSV_640_10                     0x5034 
	#define  HDMI_HDCP_KSV_640_11                     0x5035 
	#define  HDMI_HDCP_KSV_640_12                     0x5036 
	#define  HDMI_HDCP_KSV_640_13                     0x5037 
	#define  HDMI_HDCP_KSV_640_14                     0x5038 
	#define  HDMI_HDCP_KSV_640_15                     0x5039 
	#define  HDMI_HDCP_KSV_640_16                     0x503A 

	#define  HDMI_HDCP_KSV_640_17                     0x503B 
	#define  HDMI_HDCP_KSV_640_18                     0x503C 
	#define  HDMI_HDCP_KSV_640_19                     0x503D 
	#define  HDMI_HDCP_KSV_640_20                     0x503E 
	#define  HDMI_HDCP_KSV_640_21                     0x503F 
	#define  HDMI_HDCP_KSV_640_22                     0x5040 
	#define  HDMI_HDCP_KSV_640_23                     0x5041 
	#define  HDMI_HDCP_KSV_640_24                     0x5042 
	#define  HDMI_HDCP_KSV_640_25                     0x5043 
	#define  HDMI_HDCP_KSV_640_26                     0x5044 
	#define  HDMI_HDCP_KSV_640_27                     0x5045 
	#define  HDMI_HDCP_KSV_640_28                     0x5046 
	#define  HDMI_HDCP_KSV_640_29                     0x5047 
	#define  HDMI_HDCP_KSV_640_30                     0x5048 
	#define  HDMI_HDCP_KSV_640_31                     0x5049 
	#define  HDMI_HDCP_KSV_640_32                     0x504A 
	#define  HDMI_HDCP_KSV_640_33                     0x504B 

	#define  HDMI_HDCP_KSV_640_34                     0x504C 
	#define  HDMI_HDCP_KSV_640_35                     0x504D 
	#define  HDMI_HDCP_KSV_640_36                     0x504E 
	#define  HDMI_HDCP_KSV_640_37                     0x504F 
	#define  HDMI_HDCP_KSV_640_38                     0x5050 
	#define  HDMI_HDCP_KSV_640_39                     0x5051 
	#define  HDMI_HDCP_KSV_640_40                     0x5052 
	#define  HDMI_HDCP_KSV_640_41                     0x5053 
	#define  HDMI_HDCP_KSV_640_42                     0x5054 
	#define  HDMI_HDCP_KSV_640_43                     0x5055 
	#define  HDMI_HDCP_KSV_640_44                     0x5056 
	#define  HDMI_HDCP_KSV_640_45                     0x5057 
	#define  HDMI_HDCP_KSV_640_46                     0x5058 
	#define  HDMI_HDCP_KSV_640_47                     0x5059 
	#define  HDMI_HDCP_KSV_640_48                     0x505A 
	#define  HDMI_HDCP_KSV_640_49                     0x505B 
	#define  HDMI_HDCP_KSV_640_50                     0x505C 
	#define  HDMI_HDCP_KSV_640_51                     0x505D 
	#define  HDMI_HDCP_KSV_640_52                     0x505E 
	#define  HDMI_HDCP_KSV_640_53                     0x505F 
	#define  HDMI_HDCP_KSV_640_54                     0x5060 
	#define  HDMI_HDCP_KSV_640_55                     0x5061 
	#define  HDMI_HDCP_KSV_640_56                     0x5062 
	#define  HDMI_HDCP_KSV_640_57                     0x5063 
	#define  HDMI_HDCP_KSV_640_58                     0x5064 
	#define  HDMI_HDCP_KSV_640_59                     0x5065 
		     
	 
	#define  HDMI_HDCP_VH_20                          0x52A5 
		      
	#define  HDMI_HDCP_REVOC_SIZE_0                   0x52B9 
	#define  HDMI_HDCP_REVOC_SIZE_1                   0x52BA 
	#define  HDMI_HDCP_REVOC_LIST_5120                0x52BB 
	...
	// HDCP Encrypted DPK Embedded Storage Registers
	...
	HDMI_AHB_DMA_PCUV_OFFSET = 6,
        HDMI_AHB_DMA_PCUV_MASK = 0x40,
	...
	/*HDCP register field definations */
	#define BYPASS_ENCRYPTION	0x20
	#define SYNCRICHECK		0X10
	#define	ENABLE_11FEATURE	0X02
	#define HDCP_HDMI		0X01
	#define PH2UPSHFTENC		0x04
	#define HDCP_DATA_ENABLE	0X10
	#define HDCP_VSYNC_POL		0X08
	#define HDCP_HSYNC_POL		0X02
	#define HDCP_OESSWCFG		0X40
	...
	/*HDMI-Audio function declarations */
	unsigned int hdmi_compute_n(unsigned int freq, unsigned long pixel_clk, unsigned int ratio);
	unsigned int hdmi_compute_cts(unsigned int freq, unsigned long pixel_clk, unsigned int ratio);
	void hdmi_set_clock_regenerator_cts(unsigned int cts);
	void hdmi_set_clock_regenerator_n(unsigned int value);
	void hdmi_mask_writeb(u8 data, unsigned int reg, u8 shift, u8 mask);
	int hdmi_channel_allocation(int channels);

	/* hdmi console write functionailties*/
	void    hdmi_putc (const char c);
	void    hdmi_puts (const char *s);
	extern short con_hdmi_col;
	extern short con_hdmi_row;
